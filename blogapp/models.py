...
class Profile(models.Model):
    email = ForeignKey(User, on_delete=models.CASCADE, default='')
...
class Post(models.Model):   
    ...
    tags = ForeignKey(Tags, on_delete=models.CASCADE, default='')
    status = models.TextField(default='')
    content = models.TextField(default='')
    createTime = models.DateTimeField(auto_now_add=True)
    updateTime = models.DateTimeField(auto_now_add=True)
    username = ForeignKey(User, on_delete=models.CASCADE, default='')
...
class Comment(models.Model):
    ...
    username = ForeignKey(User, on_delete=models.CASCADE, default='', related_name='cmt_user')
    url = models.URLField
    email = ForeignKey(User, on_delete=models.CASCADE,default='', related_name='cmt_email')
